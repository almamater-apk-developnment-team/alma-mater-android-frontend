package com.nitt.alumni.screens
...
import com.nitt.alumni.response.AlumniUserDetails
import com.nitt.alumni.viewModels.AlumniAccountViewModel
import com.nitt.navigation.Screens
import com.nitt.theme.color_2
import com.nitt.theme.urbanist

@Composable
fun AlumniRegisterScreen(navController: NavController){
    ...
    Column(modifier= Modifier
        ...
        Button(onClick = {
            if (userDetails.rollNumber.isNotEmpty() && userDetails.username.isNotEmpty() && userDetails.password.isNotEmpty() && userDetails.designation.isNotEmpty()) {
