...
fun LandingPage(
    ...
    )
    {
        ...
        Column(
            ...
            {
                CommunityCardComponent( navController = navController, route = Screens.ClubCommunityPage.route, communityName = "Club", data = R.raw.club_community_logo)
                CommunityCardComponent( navController = navController, route = Screens.FestDirectory.route, communityName = "Fest", data = R.raw.fest_community_logo)
            }
            Row(
                modifier = Modifier.fillMaxWidth(),
                horizontalArrangement = Arrangement.SpaceAround
            ...
            )
            {
                ...
                CommunityCardComponent( navController = navController, route = Screens.CommunityPage.route, communityName = "Student", data = R.raw.student_community_logo)
            }
        }
    }
}
